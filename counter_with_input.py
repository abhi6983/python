...
# counts the numbers based on range and steps from user
...
#get the starting number and keep promting till a value is entered
start = ""
while not start:
    start = input("\nWhat number should I start from?\n")
    
#quit if user enter 'exit'
if start == "exit":
    exit()
    
#get the stopping number and keep promting till a value is entered    
stop = ""
while not stop :
...
#get the gap number and keep promting till a value is entered     
step = ""
while not step:
